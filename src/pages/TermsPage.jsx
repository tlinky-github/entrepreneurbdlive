          ...
          <div className="max-w-3xl mx-auto prose prose-stone lg:prose-lg max-w-none">
            ...
            <ul className="text-stone-600">
              <li>
                ...
                {' '}<Link to="/editorial" className="text-emerald-900 hover:text-emerald-700 font-medium">Editorial Principles</Link>.
              </li>
              <li>
            ...
            <p className="text-stone-600">
              ...
              Please refer to our <Link to="/disclaimer" className="text-emerald-900 hover:text-emerald-700 font-medium">Disclaimer</Link> for
              further details.
            </p>
            ...
            <p className="text-stone-600">
              These Terms, together with our <Link to="/privacy" className="text-emerald-900 hover:text-emerald-700 font-medium">Privacy Policy</Link> and
              {' '}<Link to="/disclaimer" className="text-emerald-900 hover:text-emerald-700 font-medium">Disclaimer</Link>,
            ...
            <p className="text-stone-600">
              ...
              our <Link to="/contact" className="text-emerald-900 hover:text-emerald-700 font-medium">contact page</Link> or
