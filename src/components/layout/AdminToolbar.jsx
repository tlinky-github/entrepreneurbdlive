         ...
         <div className="flex items-center gap-1 h-8">
           ...
           <div className="relative group h-8">
             ...
             <div className="absolute top-8 left-0 hidden group-hover:block bg-[#064e3b] border border-emerald-800 rounded-b shadow-2xl min-w-[160px] py-1 z-[1001]">
               <Link to="/admin/posts/new" className="block px-4 py-2 hover:bg-emerald-800 transition-colors">Blog Post</Link>
               <Link to="/admin/directory" className="block px-4 py-2 hover:bg-emerald-800 transition-colors">Directory Listing</Link>
               <Link to="/admin/resources/new" className="block px-4 py-2 hover:bg-emerald-800 transition-colors">Resource</Link>
               <Link to="/admin/knowledge-hub" className="block px-4 py-2 hover:bg-emerald-800 transition-colors">Knowledge Article</Link>
               <div className="h-px bg-emerald-800 my-1" />
               <Link to="/admin/users" className="block px-4 py-2 hover:bg-emerald-800 transition-colors">User</Link>
             </div>
           </div>

           <Link to="/admin/settings" className="flex items-center gap-1.5 px-3 h-8 hover:bg-emerald-800 transition-colors" title="Site Settings">
         ...
         <div className="ml-auto flex items-center h-8">
           <div className="relative group h-8">
             ...
             <div className="absolute top-8 right-0 hidden group-hover:block bg-[#064e3b] border border-emerald-800 rounded-b shadow-2xl min-w-[180px] py-1 z-[1001]">
               ...
               <Link to="/admin" className="flex items-center gap-2 px-4 py-2 hover:bg-emerald-800 transition-colors text-white">
                 <LayoutDashboard size={13} className="text-emerald-300" />
                 Admin Dashboard
               </Link>
               <Link to="/admin/settings" className="flex items-center gap-2 px-4 py-2 hover:bg-emerald-800 transition-colors text-white">
                 <Settings size={13} className="text-emerald-300" />
                 Edit Profile
               </Link>
               <div className="h-px bg-emerald-800 my-1" />
