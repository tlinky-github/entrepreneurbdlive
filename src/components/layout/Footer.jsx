        ...
        <div className="py-12 lg:py-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex gap-4">
              <a href="#" className="w-10 h-10 bg-stone-800 hover:bg-emerald-900 rounded-lg flex items-center justify-center transition-colors" aria-label="Facebook" target="_blank" rel="nofollow noopener noreferrer">
                <Facebook className="w-5 h-5" />
              </a>
              <a href="#" className="w-10 h-10 bg-stone-800 hover:bg-emerald-900 rounded-lg flex items-center justify-center transition-colors" aria-label="Twitter" target="_blank" rel="nofollow noopener noreferrer">
                <Twitter className="w-5 h-5" />
              </a>
              <a href="#" className="w-10 h-10 bg-stone-800 hover:bg-emerald-900 rounded-lg flex items-center justify-center transition-colors" aria-label="LinkedIn" target="_blank" rel="nofollow noopener noreferrer">
                <Linkedin className="w-5 h-5" />
              </a>
              <a href="#" className="w-10 h-10 bg-stone-800 hover:bg-emerald-900 rounded-lg flex items-center justify-center transition-colors" aria-label="YouTube" target="_blank" rel="nofollow noopener noreferrer">
