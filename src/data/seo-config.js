export const SEO_CONFIG = {
    ...
    default: {
        ...
        type: "website",
        image: "https://images.unsplash.com/photo-1627599936744-51d288f89af4?w=1200&h=630&fit=crop", // Default social image
    },
    ...
    directory: {
        title: "Business Directory | Find Startups & SMEs in Bangladesh",
        description: "Browse our comprehensive directory of verified businesses, startups, and service providers in Bangladesh.",
        keywords: ["business directory", "company search", "dhaka startups", "service providers"],
    },
    knowledge: {
        title: "Knowledge Hub | Resources for Entrepreneurs",
        description: "Access free guides, templates, and frameworks to help you start and grow your business.",
    ...
    entrepreneurs: {
        title: "Meet the Entrepreneurs | Inspiring Profiles",
        description: "Connect with the ambitious founders and leaders shaping the future of business in Bangladesh.",
    ...
    glossary: {
        title: "Business Glossary | Entrepreneur Terms Defined",
        description: "A comprehensive glossary of common business and startup terminology.",
