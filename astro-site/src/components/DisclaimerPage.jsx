        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white border border-stone-200 mb-6 shadow-sm">
              <ShieldAlert className="w-4 h-4 text-emerald-900" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto prose prose-stone lg:prose-lg max-w-none">
            ...
            <p className="text-stone-600">
              ...
              <a href="/contact" className="text-emerald-900 hover:text-emerald-700 font-medium"> contact page</a>.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-10 bg-stone-50 border-t border-stone-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto">
            <a href="/" className="inline-flex items-center gap-2 px-6 py-3 border border-emerald-900 text-emerald-900 rounded-lg text-sm font-medium hover:bg-emerald-50 transition-colors">
