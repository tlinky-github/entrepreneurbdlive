      ...
      <CardContent className="p-6 flex flex-col h-full">
        <div className="flex-1">
          <div className="flex items-start gap-4">
            <div className="w-16 h-16 bg-white border border-stone-200 rounded-2xl flex items-center justify-center flex-shrink-0 overflow-hidden p-2">
              {listing.logo ? (
          ...
          <div className="min-h-[1.75rem] flex items-center mt-3">
          ...
          {(listing.details || listing.short_description) && (
            <p className="text-sm text-stone-600 mt-2 line-clamp-6 flex-1 overflow-hidden">
              {listing.details || listing.short_description}
            </p>
          )}
        </div>

        <div className="flex items-center gap-4 mt-auto pt-4 border-t border-stone-100 text-sm text-stone-400">
          {listing.website && (
