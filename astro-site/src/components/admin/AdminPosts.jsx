...
const AdminPosts = () => {
  ...
  const getStatusBadge = (status) => {
    const styles = {
      published: 'border-transparent bg-emerald-100 text-emerald-800 hover:bg-emerald-200 hover:text-emerald-900 font-medium',
      draft: 'border-transparent bg-amber-100 text-amber-800 hover:bg-amber-200 hover:text-amber-900 font-medium',
      pending: 'border-transparent bg-blue-100 text-blue-800 hover:bg-blue-200 hover:text-blue-900 font-medium',
      scheduled: 'border-transparent bg-purple-100 text-purple-800 hover:bg-purple-200 hover:text-purple-900 font-medium',
    };
    return <Badge variant="secondary" className={styles[status] || 'border-transparent bg-stone-100 text-stone-800 hover:bg-stone-200 font-medium'}>{status}</Badge>;
  };
