    ...
    <div className="admin-content-manager">
      ...
      {showCategoryModal && (
        <div className="modal-overlay" onClick={() => setShowCategoryModal(false)}>
          <Card className="w-[90%] max-w-md max-h-[85vh] flex flex-col" onClick={(e) => e.stopPropagation()}>
            <CardHeader className="flex-shrink-0">
              <CardTitle>Manage Categories</CardTitle>
            </CardHeader>
            <CardContent className="flex flex-col flex-1 overflow-hidden p-6 pt-0">
              <div className="flex-1 overflow-y-auto pr-2 mb-6 space-y-2">
                {categories.map(cat => (
                  <div key={cat.id} className="flex justify-between items-center p-3 bg-stone-50 border border-stone-200 rounded-md">
                    <span className="font-medium text-sm">{cat.name}</span>
                    <Trash2 
                      size={16} 
                      className="cursor-pointer text-red-500 hover:scale-110 transition-transform opacity-60 hover:opacity-100" 
              ...
              <div className="flex-shrink-0 pt-4 border-t border-stone-100 space-y-4">
                <div className="flex gap-2">
                  <Input
                  ...
                  />
                  <Button onClick={handleCreateCategory} className="whitespace-nowrap">Add Category</Button>
                </div>
