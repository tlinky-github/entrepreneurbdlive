...
import {
  ...
  ChevronDown, ChevronUp, Loader2, Search, MoreVertical, Eye, Pencil, Filter, Link as LinkIcon, ExternalLink, ArrowUpDown
} from 'lucide-react';
import {
      ...
      <Card className="border-stone-200">
        <CardHeader className="flex flex-row items-center justify-between border-b border-stone-200 bg-stone-50/50">
          ...
          <div className="flex items-center gap-2">
            ...
            >
              <ArrowUpDown className="w-4 h-4 mr-2" /> Quick Reorder ({articles.length})
            </Button>
                        ...
                        <TableCell className="font-mono text-xs font-bold">
                          <div className="flex items-center gap-1">
                            ...
                            <input
                              type="number"
                              min="1"
                              defaultValue={article.order || (globalIdx + 1)}
        ...
        <DialogContent className="max-w-3xl max-h-[85vh] flex flex-col">
          <DialogHeader className="border-b border-stone-200 pb-4">
            ...
            <DialogDescription className="text-xs text-stone-500 mt-1">
              Reorder articles by typing position numbers or using quick sorting helpers.
            </DialogDescription>
          </DialogHeader>
